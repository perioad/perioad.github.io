...
export const Avatar = () => {
  ...
  return (
    <>
      <div className="relative h-60 w-60 overflow-hidden before:absolute before:top-1/2 before:left-1/2 before:h-100 before:w-50 before:origin-top before:-translate-x-1/2 before:animate-spin-border before:bg-linear-to-l before:from-transparent before:via-pink-500 before:to-transparent motion-reduce:before:hidden sm:h-96 sm:w-96 sm:before:w-75">
